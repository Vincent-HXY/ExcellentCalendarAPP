// Isolated extraction from common/search_token_crypto.cpp for independent KAT.
// First-party repository code; no new third-party cryptographic dependency.
// Only the byte counter is widened to uint64_t for 32-bit ABI consistency.
#pragma once
#include <algorithm>
#include <array>
#include <cstdint>
